...
const Terms: React.FC = () => {
  return (
    <>
      <Head>
        <title>Termos e Condições - Hotel Canto da Praia</title>
        <meta name="description" content="Leia os termos e condições para reserva e hospedagem no Hotel Canto da Praia." />
        <meta name="robots" content="noindex, follow" />
        <meta property="og:title" content="Termos e Condições - Hotel Canto da Praia" />
        <meta property="og:description" content="Leia os termos e condições para reserva e hospedagem no Hotel Canto da Praia." />
        <meta property="og:url" content="https://www.hotelcantodapraia.com.br/terms" />
      </Head>
